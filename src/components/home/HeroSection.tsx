            ...
            <div className="relative bg-card rounded-3xl shadow-xl p-4 sm:p-5 lg:p-5 xl:p-6 border border-border/40">
              ...
              <div className="relative grid gap-3 sm:gap-3.5 lg:gap-4 grid-cols-1 sm:grid-cols-2">
                ...
                <div className="flex flex-col justify-between gap-2 p-3 sm:p-3.5 lg:p-3.5 xl:p-4 bg-muted/70 hover:bg-muted rounded-2xl h-full transition-colors">
                  ...
                  <p className="font-body text-xs sm:text-[13px] text-muted-foreground mt-1 leading-relaxed">Master GenAI, LLMs, RAG, and Agentic AI to engineer the intelligent systems powering tomorrow’s technology.</p>
                </div>
                ...
                <div className="flex flex-col justify-between gap-2 p-3 sm:p-3.5 lg:p-3.5 xl:p-4 bg-muted/70 hover:bg-muted rounded-2xl h-full transition-colors">
                  <div>
                    ...
                    <p className="font-heading font-semibold text-foreground text-sm sm:text-[15px]">Career-Focused Support</p>
                  </div>
                  <p className="font-body text-xs sm:text-[13px] text-muted-foreground mt-1 leading-relaxed">Portfolio building, technical interview prep, and guidance to step into tech roles.</p>
                </div>
